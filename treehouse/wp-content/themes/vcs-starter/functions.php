...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		wp_register_style('font', 'https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,700,700i|Roboto+Slab:300,400,700', array(), false, 'all'); 
		wp_register_style('font-awesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css', array(), false, 'all');	
		wp_register_style('main-css', ASSETS_URL . '/assets/style.css', array('font', 'font-awesome'), false, 'all');
