...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_deregister_script('jquery');
				wp_register_script('jquery', ASSETS_URL . '/assets/js/jquery.js', false, true);
				
				wp_register_script('waypoints', ASSETS_URL . '/assets/js/jquery.waypoints.min.js', false,  true);
				wp_register_script('bootstrap-js', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/js/bootstrap.min.js', false,  true);
				wp_register_script('owl-carousel-js', ASSETS_URL . '/assets/js/owl.carousel.min.js', false,  true);
				wp_register_script('popper-js', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js', false,  true);
        wp_register_script('js_main', ASSETS_URL . '/assets/js/custom.js', array('jquery','waypoints','popper-js','bootstrap-js', 'owl-carousel-js', ), '1.0', true);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		wp_register_style('font-lato', 'https://fonts.googleapis.com/css?family=Lato:400,600,700,900', array(), false, 'all');
		wp_register_style('font-poppins', 'https://fonts.googleapis.com/css?family=Poppins:700', array(), false, 'all');
		wp_register_style('font-awesome','https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css', array(), false, 'all');
		wp_register_style('bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/css/bootstrap.min.css', array(), false, 'all');
		wp_register_style('owl-carousel-css', ASSETS_URL . '/assets/owl.carousel.min.css', array(), false, 'all');
		wp_register_style('owl-carousel-theme-css', ASSETS_URL . '/assets/owl.theme.default.min.css', array(), false, 'all');
		wp_register_style('main-css', ASSETS_URL . '/assets/style.css', array('font-lato', 'font-poppins', 'font-awesome', 'bootstrap', 'owl-carousel-css','owl-carousel-theme-css'), false, 'all');
